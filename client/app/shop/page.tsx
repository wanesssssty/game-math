...
export default function ShopPage() {
  ...
  if (!isAuthenticated) {
    return (
      <SiteFrame>
        <AuthRequired
          title="Магазин котиків"
          description="Тут можна обміняти цукерки на нових пухнастих друзів. Спочатку зароби цукерки в тестах і тренуваннях, а потім увійди — щоб покупки збереглись."
          perks={[
            "Купуй скіни для свого котика",
            "Відкривай рідкісні образи",
            "Одягай нагороди в інвентарі",
          ]}
          playHref="/addition"
